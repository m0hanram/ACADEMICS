...
CHECK:
        MOV CX, 3;   CX is used internally for REPE CMPSB. So storing length of the substring in CX would limit the number of characters for comparison to exact length of substring.
...
GREEN:  
        MOV al, 01H;  substring found
        JMP EXIT


RED:    
        MOV al, 00H;  substring not found
        JMP EXIT
